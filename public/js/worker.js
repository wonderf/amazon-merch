...
function start(evt) {
    ...
    var updateProgress = function (word, cur, total) {
        ...
        if (progress >= callbacks.length) {
            ...
            $('#searchEngine').append(
                pushing.map(function (r) {
                    return `<li style="display: block;padding-bottom: 13px;padding-top: 13px;margin-bottom: -1px"><a href="https://www.amazon.com/s?k=${r}">Amazon</a> | <a href="https://www.google.com/search?q=${r}">Google</a></li>`
                })
            )
